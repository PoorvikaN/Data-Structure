...
# Creating a stack using liked list
...
# Implementing a queue data structure using SLL
...
# designing a queue-based system to manage the queue of 
regular customers waiting to purchase cinema tickets at a popular movie theatre. 
